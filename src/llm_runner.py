...
def run_llm(
    ...
    # --- Codex CLI runner (cuando manual_model_key=codex_mini o rol tests, con sesión activa) ---
    _CODEX_ROLES = ("tests", "coder")
    use_codex_cli = (manual_model_key == "codex_mini" or agent_role in _CODEX_ROLES) and repo_path
    if use_codex_cli:
